<?php include "header.php"; ?>
        ...
        <div class="coupons bg padTB60">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="coupons-list marB30">
                            <div class="col-md-4 col-sm-4 col-xs-12 box-r">
                                <div class="box-b box-e">
                                    <figure>
                                        <img src="assets/img/all/layer14.jpg" alt="">
                                    </figure>
                                </div>
                            </div>
                                ...
                                <div class="box-detail details detail">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="row">
                                            ...
                                            <h4 class="marB20 marT20">Stores <span class="grey-a">- amazon,snapdeal</span></h4>
                                            <h4 class="marB20">expires :<span class="red"> 25-11-2017 </span></h4>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="coupons-list marB30">
                            <div class="col-md-4 col-sm-4 col-xs-12 box-r">
                                <div class="box-b box-e">
                                    <figure>
                                        <img src="assets/img/all/layer15.jpg" alt="">
                                    </figure>
                                </div>
                            </div>
                            <div class="col-md-8 col-sm-8 col-xs-12 padL0 box-l">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="coupons-list marB30">
                            <div class="col-md-4 col-sm-4 col-xs-12 box-r">
                                <div class="box-b box-e">
                                    <figure>
                                        <img src="assets/img/all/layer16.jpg" alt="">
                                    </figure>
                                </div>
                            </div>
                            <div class="col-md-8 col-sm-8 col-xs-12 padL0 box-l">
...
<!-- Mirrored from preview.yrthemes.com/thanks-giving/coupon-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Dec 2017 14:59:23 GMT -->
</html>